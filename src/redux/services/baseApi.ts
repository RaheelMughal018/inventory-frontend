...
export const baseApi = createApi({
  ...
  tagTypes: ['auth', 'supplier', 'customer', 'category', 'item','account', 'purchase_invoice', 'payment', 'financial-ledger', 'stock-ledger', 'expense_category', 'expense', 'recipe', 'production', 'stock_adjustment'],
  endpoints: () => ({}), 
})
